		...
		<div id="cart" className="z-30">
			...
			<div className={`Cart ${cartStatus ? "Cart--open" : ""}`}>
				<div className="App__view-cart-wrapper2">
					...
					<ShoppingCartIcon
            className="text-accent relative z-30 right-5 top-7 ml-2 mr-2 h-6 w-6 text-orange-300 transition duration-150 ease-in-out group-hover:text-opacity-80 md:-right-0 md:relative med:right-3 lg:right-20 lg:-ml-8"
            aria-hidden="true"
          />
				...
				<div className="titleWrapper">
						<h2>Your cart</h2>
						<div className="absolute right-10 top-10 whitespace-nowrap">
					...
					<ShoppingCartIcon
            className="text-default relative right-8 top-7
