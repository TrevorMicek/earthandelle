		...
		<div id="cart" className="z-30">
			...
			<div className={`Cart ${cartStatus ? "Cart--open" : ""}`}>
				<div className="App__view-cart-wrapper2">
					...
					<ShoppingCartIcon
            className="text-accent relative z-30 right-0 top-7  mr-2 h-6 w-6 text-orange-300 transition duration-150 ease-in-out group-hover:text-opacity-80 md:-right-2 md:relative med:-right-6 hover:text-secondary"
            aria-hidden="true"
          />
