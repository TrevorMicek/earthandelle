    ...
    const KneePain = () => (
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg prose-indigo mx-auto mt-6 text-gray-800">
            ...
            <li>
                <h3 style={{fontSize:"22px"}}>Benefits Of Collagen For Other Joints</h3>
            ...
            <li>
                <h4 style={{fontSize:"22px"}}>Collagen And Arthritis Aches</h4>
            ...
            <li>
                <h5 style={{fontSize:"22px"}}>How Does Collagen Work?</h5>
            ...
            <li>
                <h6 style={{fontSize:"22px"}}>Natural And Supplemental Collagen</h6>
          ...
          <h7 style={{fontSize:'24px', fontWeight:'bold'}}>Final Verdict</h7>
            <p>
