...
const navigation = {
    ...
    social: [
      ...
      },
      {
        ...
        icon: (props) => (
          <svg width="45px" height="45px"  fill="currentColor" {...props} viewBox="0 0 43 43 " version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
      ...
      },
      {
        ...
        href: 'https://www.linkedin.com/company/earth-and-elle/?viewAsMember=true',
        icon: (props) => (
          <svg width="52px" height="52px" fill="currentColor" {...props} viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
      ...
      },
      {
        ...
        icon: (props) => (
          <div className="">
          <svg width="29px" height="29px" {...props} xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-pinterest" viewBox="0 0 24 24">
      ...
      <footer className="bg-accent" style={{gridColumn: 'span 5'}}>
        <div className="max-w-7xl mx-auto pt-8 overflow-hidden">
          ...
          <div className="bg-secondary py-3 mx-0">
            ...
            <div className="my-4 mt-7 flex mx-auto justify-center space-x-1">
            {navigation.social.map((item) => (
              <a key={item.name} href={item.href} className="-ml-2 text-black hover:text-secondary  ">
                <span className="sr-only">{item.name}</span>
                <item.icon className="h-6 w-6" aria-hidden="true" />
              </a>
            ))}
          </div>
          <p className="mt-6 text-center text-sm text-black">&copy; 2022, earthandelle</p>
        </div>
        </div>
      </footer>
    )
