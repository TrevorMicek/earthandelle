 ...
 return (
    ...
    <div className="relative overflow-hidden" style={{gridColumn:"span 5", gridRowStart:"header", gridRowEnd:"main"}}>
      ...
      <Popover as="header" className="relative ">
        <div className="bg-default py-1 ">

          <nav
            className="relative  mx-auto  items-center justify-start px-4 sm:px-6"
            aria-label="Global"
          >
            <div className="w-full flex flex-row space-x-2   justify-start ">
            <Link to="/">
                  {/* Illustration taken from Lucid Illustrations: https://lucid.pixsellz.io/ */}
                  <img
                    className="w-20 my-auto absolute mx-auto  md:mt-3 "
                    src={Logo}
          ...
          <div className="  mx-auto flex justify-center mt-10 absolute w-screen left-0 md:hidden ">
            ...
            <ShoppingBagIcon width="20px" height="20px" className="text-white w-6 h-6 relative z-10 md:hidden hover:text-secondary" />
              ...
              <div className=" hidden mx-auto mt-3 max-w-24 -mb-3 justify-center  space-x-3 sm:flex">
            {navigation.social.map((item) => (
              <a key={item.name} href={item.href} className="text-white hover:text-secondary">
                <span className="sr-only">{item.name}</span>
                <item.icon className="h-6 w-6" aria-hidden="true" />
              ...
              <div className=" hidden w-1/12 md:flex right-10 mt-7 md:absolute z-10 cursor-pointer">
                  <Link to="/store">
            <ShoppingBagIcon width="20px" height="20px" className="text-accent w-7 h-7 relative mt-4 z-10 hover:text-secondary" />
            </Link>
            </div>
